...
export default function ContactFooter() {
    return (
        <footer className="bg-black text-white mt-[250px]">
            ...
            <div className="py-6 flex flex-col items-center text-center mt-14">
                ...
                <nav className="flex flex-wrap justify-center sm:justify-between gap-4 px-3 text-[14px] font-normal font-segoe mt-3 mb-6 text-footer">
                    ...
                    <a href="#" className="hover:text-orange-500">Career</a>
